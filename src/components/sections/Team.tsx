...
const founders: Member[] = [
    {
        ...
        // photo: "/team/joao.jpg",
        bio:
            "Estrategista de dados com foco em comportamento e opinião pública. Lidera a visão do produto e a abordagem integrada entre influência, sentimento e narrativa, conectando sinais do digital a decisões práticas para comunicação, reputação e marketing.",
    },
    {
        name: "Rafael Nonato",
        ...
        bio:
            "Engenheiro de software com experiência em IA aplicada e produtos data-driven. Conduz a arquitetura da plataforma e o roadmap técnico, garantindo escalabilidade, qualidade dos modelos e uma experiência fluida do dado à ação.",
    },
];
...
const specialists: Member[] = [
    {
        ...
        bio:
            "Responsável pelo marketing interno da DADODADO e PM do Pulso Público. Garante que a coleta de respostas via anúncios opere de forma eficiente e escalável, unindo performance e qualidade de amostra.",
    },
    {
        name: "Lucas Pires",
        ...
        bio:
            "Desenvolve modelos e rotinas para coleta e análise automática em redes sociais. Evolui o Lupa Social com NLP (classificação de sentimentos, detecção de temas e entidades) para transformar ruído em insight acionável.",
    },
    {
        ...
        bio:
            "Lidera plano amostral e desenho de pesquisas do Pulso Público. Atua na ponderação e calibração pós-coleta (pós-estratificação, rake) e na modelagem de índices compostos como o Pêndulo Digital e novos produtos.",
    },
];
...
function PhotoOrPlaceholder({ member, tall = false }: { member: Member; tall?: boolean }) {
    const heightClass = tall ? "h-40 sm:h-48" : "h-36 sm:h-40";
    if (member.photo) {
        return (
            <div className={`relative ${heightClass} w-full overflow-hidden rounded-xl ring-1 ring-[#38d4b0]/20`}>
                <Image
                    src={member.photo}
                    alt={member.name}
                    fill
        ...
        <section className="relative bg-[#170d4d] text-[#d9d9d9]">
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
                ...
                <div className="text-center">
                    ...
                    <Reveal delay={120}>
                        <p className="mt-4 text-base sm:text-lg lg:text-xl text-[#d9d9d9]/85">
                            Um time que integra estratégia, engenharia e métodos para gerar clareza — do dado ao resultado.
                        </p>
                    </Reveal>
                </div>
                ...
                <div className="mt-10 sm:mt-12">
                    ...
                    <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6 lg:gap-8">
                  ...
                  "
                                >
                                    ...
                                    <div className="mt-4">
                                        ...
                                        <p className="mt-2 text-sm sm:text-base text-[#d9d9d9]/85">{m.bio}</p>
                                    </div>
                                </article>
                            ))}
                        </StaggerList>
