// app/servicos/lupa-social/page.tsx
'use client';
...
import {
  Search, MessageSquare, Brain, Sparkles, ArrowRight, BarChart3,
  Activity, Share2, LineChart, Target, BellRing, Filter, Network
} from 'lucide-react';
...
export default function LupaSocialPage() {
  return (
    <main className="min-h-screen bg-[#170d4d] text-[#d9d9d9]">
          ...
          <div className="text-center max-w-4xl mx-auto">
            <Reveal>
              <p className="uppercase tracking-widest text-xs sm:text-sm text-[#38d4b0]">
                serviço • social listening com ia
              </p>
            </Reveal>
            <Reveal delay={100}>
            ...
            <Reveal delay={180}>
              <p className="mt-5 text-base sm:text-lg lg:text-xl text-[#d9d9d9]/85">
                Monitoramento e análise inteligente de <strong>conteúdo</strong> e <strong>sentimento</strong> nas redes, com análise de termos,
                hashtags, temas e posts relevantes.
              </p>
            </Reveal>
            <Reveal delay={240}>
          ...
          <div className="grid gap-8 lg:grid-cols-12">
            <div className="lg:col-span-5">
              ...
              <Reveal delay={100}>
                <p className="mt-3 text-[#d9d9d9]/85">
                  Um módulo de <strong>social listening</strong> com <strong>NLP</strong> (Processamento de Linguagem Natural) para entender
                  como públicos falam sobre sua marca, temas e concorrentes: <strong>polaridade</strong> e <strong>intensidade</strong> do sentimento,
                  <strong> tópicos</strong> e <strong>frames</strong> dominantes e indicadores de oportunidade/risco.
                </p>
              </Reveal>
            </div>
            ...
            <div className="lg:col-span-7 flex flex-col gap-4">
              <StaggerList step={90} y={20}>
                {[
                  { icon: MessageSquare, label: 'Sentimento qualificado', desc: 'Polaridade + intensidade e variação por período.' },
                  { icon: Brain, label: 'Detecção de temas', desc: 'Tópicos, tendências e conversas para entender o debate.' },
                  { icon: Filter, label: 'Processamento de linguagem', desc: 'Análise de conteúdo e sentimento nas redes com IA.' },
                ].map((f) => (
      ...
      <section className="relative bg-[#170d4d]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-12 sm:pb-16">
          <Reveal><h2 className="text-2xl sm:text-3xl font-bold">As 5 dimensões da leitura</h2></Reveal>
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5">
            <StaggerList step={70} y={14}>
              {[
                { icon: Activity, title: 'Volume', desc: 'Menções por período, canais e variação.' },
                { icon: MessageSquare, title: 'Sentimento', desc: 'Polaridade (±) e intensidade, com distribuição por tema.' },
                { icon: Brain, title: 'Temas', desc: 'Clusters de tópicos, tendências e frames.' },
                { icon: Share2, title: 'Difusão', desc: 'Tração orgânica (reposts/compartilhamentos) e hubs.' },
              ].map((d) => (
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-12 sm:pb-16">
          ...
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            <StaggerList step={80} y={14}>
              {[
                { icon: BarChart3, title: 'Overview', desc: 'Volume, sentimento e difusão por período e canal.' },
                { icon: LineChart, title: 'Séries & picos', desc: 'Detecção de picos com amostras e explicações.' },
                { icon: Brain, title: 'Mapa de temas', desc: 'Clusters e ocorrências com exemplos-chave.' },
                { icon: Network, title: 'Atores & hubs', desc: 'Quem amplifica e quem é referência por tema.' },
                { icon: BellRing, title: 'Alertas', desc: 'Mudanças bruscas de tom, volume e tração.' },
                { icon: Target, title: 'Recomendações', desc: 'Ações por narrativa/canal e oportunidades de inserção.' },
              ].map((i) => (
            ...
            >
              ...
              <div className="flex flex-col gap-5 sm:gap-6">
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 text-sm">
                  {[
                    'Sentimento (polaridade + intensidade) por tema e canal',
                    'Clusters de tópicos, temas e ocorrências',
                    'Séries temporais e picos com amostras explicativas',
                    'Atores/hubs que são referência',
                    'Alertas de mudanças bruscas e risco/oportunidade',
